...
@EnvModel()
export class EngineStaticEnvironments {
  // middlewares
  @EnvModelProperty({
  ...
  @EnvModelProperty({
    ...
    default: Object.keys(EngineRole),
  ...
  defaultPublicProjects?: EngineProjectType[];
  ...
  defaultProject?: EngineProjectType;
