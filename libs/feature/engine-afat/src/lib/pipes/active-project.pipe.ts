...
export class ActiveProjectPipe implements PipeTransform {
  constructor(private readonly engineActiveProjectService: EngineActiveProjectService) {}

  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  public transform(value: any) {
    return this.engineActiveProjectService.activePublicProject$.asObservable().pipe(
